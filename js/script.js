document.addEventListener('DOMContentLoaded', function () {
   ...
   const gitKnowledgeBase = {
    commands: [
        ...
        {
            keywords: ['atualizar', 'baixo', 'pego', 'baixar atualizações', 'pull', 'puxar alterações', 'sincronizar', 'git pull', 'trazer mudanças', 'atualizar local'],
        ...
        {
            keywords: ['mesclar', 'merge', 'juntar branches', 'combinar branches', 'git merge', 'integrar código', 'unir branches'],
        ...
        {
            keywords: ['remoto', 'adicionar remoto', 'configurar origin', 'conectar repositório remoto', 'git remote add', 'vincular ao GitHub', 'configurar remoto'],
        ...
        {
            keywords: ['stash', 'salvar para depois', 'armazenar alterações', 'guardar alterações temporariamente', 'guardar temporariamente', 'git stash', 'esconder mudanças'],
            command: 'git stash',
        ...
        {
            keywords: ['renomear branch', 'renomeio', 'renomear', 'mudar nome da branch', 'alterar nome branch', 'git branch -m', 'branch move', 'modificar nome da ramificação', 'trocar nome', 'branch rename', 'renomear ramificação atual'],
            command: 'git branch -m [novo-nome]',
            explanation: 'Renomeia a branch atual para o novo nome especificado. Para renomear uma branch diferente da atual, use o formato git branch -m [nome-antigo] [novo-nome]. A flag -m significa "move" (mover), pois tecnicamente o Git está movendo a branch para um novo nome.',
            category: 'branching',
            importance: 7
        },
        {
        ...
        {
            keywords: ['reflog', 'histórico de referências', 'recuperar branch deletada', 'histórico de operações', 'git reflog', 'encontrar commit perdido', 'recuperar estado anterior'],
            command: 'git reflog',
        ...
        {
            keywords: ['switch', 'mudar branch moderno', 'trocar branch git 2.23', 'alternar branch', 'git switch', 'comando moderno', 'alternativa a checkout'],
        ...
        {
            keywords: ['restore', 'restaurar arquivo', 'desfazer alterações arquivo', 'recuperar arquivo', 'git restore', 'voltar arquivo ao estado anterior', 'descartar mudanças em arquivo'],
        ...
        {
            keywords: ['amend no-edit', 'adicionar ao último commit', 'commit --amend --no-edit', 'corrigir sem mudar mensagem', 'git commit --amend --no-edit', 'completar último commit', 'adicionar esquecido'],
        ...
        {
            keywords: ['log author', 'filtrar por autor', 'commits de autor', 'histórico por pessoa', 'git log --author', 'ver o que alguém fez', 'filtrar histórico por pessoa'],
        ...
        {
            keywords: ['set-upstream', 'configurar branch para push', 'push --set-upstream', 'definir branch remota', 'git push -u', 'conectar branch local e remota', 'configurar push padrão'],
